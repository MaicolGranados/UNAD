            ...
            { "data": "fechaExpedicion", "width": "10%" },
            {
                ...
                "render": function (data) {
                    return `<div class="text-center">
                                <a href="/Admin/Certificados/Edit/${data}" class="btn btn-success text-white" style="cursor:pointer; width:100px;">
                                <i class="far fa-edit"></i>Editar
                                </a>
                                &nbsp;
                                <a onclick=Delete("/Admin/Certificados/Delete/${data}") class="btn btn-danger text-white" style="cursor:pointer; width:100px;">
